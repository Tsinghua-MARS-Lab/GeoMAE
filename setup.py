...
if __name__ == '__main__':
    setup(
        ...
        ext_modules=[
            ...
            # make_cuda_ext(
            #     name='wnms_4c_ext',
            #     module='mmdet3d.ops.wnms',
            #     sources=[
            #         'src/wnms.cpp',
            #     ]),
            make_cuda_ext(
                name='votr_ops_cuda',
                module='mmdet3d.ops.votr_ops',
                sources=[
                    'src/votr_api.cpp',
            ...
            make_cuda_ext(
                name='sparse_index_ext',
                module='mmdet3d.ops.sparse_index',
                sources=[
                    'src/sparse_index.cpp',
                    'src/sparse_index_cuda.cu',
                    'src/sparse_index_cuda_test.cu',
                    'src/sparse_index_cuda_w_pos.cu',
                ]),
            make_cuda_ext(
                name='iou3d_cuda',
