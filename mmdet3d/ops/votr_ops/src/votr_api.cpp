...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("build_mapping_with_hash_test_wrapper", &build_mapping_with_hash_test_wrapper, "build_mapping_with_hash_test_wrapper");
    ...
    m.def("window_attention_with_tensor_wrapper", &sparse_strided_attention_with_tensor_wrapper, "sparse_strided_attention_with_tensor_wrapper");
    m.def("window_attention_with_hash_wrapper", &sparse_strided_attention_with_hash_wrapper, "sparse_strided_attention_with_hash_wrapper");
    ...
    m.def("window_focal_attention_with_hash_wrapper",&window_focal_attention_with_hash_wrapper,"window_focal_attention_with_hash_wrapper");
    m.def("window_focal_attention_with_hash_test_wrapper",&window_focal_attention_with_hash_test_wrapper,"window_focal_attention_with_hash_test_wrapper");
}