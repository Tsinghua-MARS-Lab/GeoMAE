...
@HEADS.register_module()
class CenterHeadWaymo(BaseModule):
    ...
    def __init__(self,
        ...
        assert init_cfg is None, 'To prevent abnormal initialization ' \
            'behavior, init_cfg is not allowed to be set'
        super(CenterHeadWaymo, self).__init__(init_cfg=init_cfg)

        num_classes = [len(t['class_names']) for t in tasks]
        self.class_names = [t['class_names'] for t in tasks]
        self.use_mul_nms=use_mul_nms
    ...
    def get_bboxes(self, preds_dicts, img_metas, img=None, rescale=False):
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            ...
            if self.use_mul_nms:
                ...
                pre_maxsize = self.test_cfg['pre_max_size'][task_id]
            ...
            if self.test_cfg['nms_type'] == 'circle':
                ...
                rets.append(
                    self.get_task_detections(num_class_with_bg,
                                             ...
                                             batch_cls_labels, img_metas,thresh, pre_maxsize,post_max_size))
    ...
    def get_task_detections(self, num_class_with_bg, batch_cls_preds,
                            batch_reg_preds, batch_cls_labels, img_metas,thresh_cls,pre_maxsize_cls,post_max_size_cls):
        ...
        for i, (box_preds, cls_preds, cls_labels) in enumerate(
            ...
            if top_scores.shape[0] != 0:
                ...
                selected = nms_gpu(
                    ...
                    top_scores,
                    thresh=thresh_cls,
                    pre_maxsize=pre_maxsize_cls,
                    post_max_size=post_max_size_cls)
            else:
                selected = []
