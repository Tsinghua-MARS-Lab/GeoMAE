...
class SSTInputLayerSpconv2OnlySubm(nn.Module):
    """
    ...
    def __init__(self,
        ...
        self.sconv1 = spconv.SparseSequential(
            post_act_block(
                in_channel,
                stage_channels[0],
                3,
            ...
            post_act_block(
                ...
                norm_fn=norm_fn,
                padding=1,
                indice_key='subm1_down',
                ))
        self.sconv2 = spconv.SparseSequential(
            post_act_block(
                stage_channels[1],
                stage_channels[1],
                3,
            ...
            post_act_block(
                ...
                norm_fn=norm_fn,
                padding=1,
                indice_key='subm2_down',
                ))
        self.sconv3 = spconv.SparseSequential(
            post_act_block(
                stage_channels[2],
                stage_channels[2],
                3,
    ...
    def forward(self, voxel_feat, coors,batch_size):
        ...
        self.set_drop_info()
        voxel_info = {}
        # print('voxel_feat', voxel_feat.dtype,coors.dtype)
        coors = coors.int()
        ...
        sp_tensor = spconv.SparseConvTensor(voxel_feat, coors,
                                            self.spatial_shape,
                                            batch_size)
        # print('1 ',sp_tensor.spatial_shape)
        sp_tensor = self.sconv1(sp_tensor)
        # print('2 ', sp_tensor.spatial_shape)
        sp_tensor = self.sconv2(sp_tensor)
        # print('3 ', sp_tensor.spatial_shape)
        sp_tensor = self.sconv3(sp_tensor)
        print('3 out ', sp_tensor.spatial_shape)
        sp_tensor = self.conv_out(sp_tensor)
        # print('final out ', sp_tensor.spatial_shape)
        voxel_feat = sp_tensor.features
        # print(sp_tensor.spatial_shape)
