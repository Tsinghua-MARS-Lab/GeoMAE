...
class MultiMAESSTDensitySP(nn.Module):
    '''
    ...
    def forward_decoder(self, visible_voxel_feat,coors,coors_mask,batch_size):
        ...
        reg_pred_nor_low = self.decoder_pred_density_low(density_masked_output)
        reg_pred_nor_med = self.decoder_pred_density_med(density_masked_output)
