...
class SpasreMultiscaleEncoder(nn.Module):
    """
    ...
    def __init__(self,
        ...
        #     spconv.SubMConv3d(
        #         in_channel, stage_channels[0], kernel_size=3, stride=1, padding=1, bias=False, indice_key='subm1'),
        #     spconv.SubMConv3d(
        #         stage_channels[0], stage_channels[0], kernel_size=3, stride=1, padding=1, bias=False,
        #         indice_key='subm1'),
        # )
        #
        # self.sconv_downsample = spconv.SparseSequential(
        #     spconv.SparseConv3d(
        #         stage_channels[0], stage_channels[1], kernel_size=[3, 3, 3], stride=[2, 2, 2], padding=[0, 1, 1],
        #         bias=False, indice_key='spconv1'),
        # )
        self.sconv = spconv.SparseSequential(
