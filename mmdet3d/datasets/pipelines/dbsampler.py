...
class DataBaseSamplerSSL(object):
    ...
    def sample_all(self,img=None):
        ...
        first = True
        avoid_coll_boxes = None
        for class_name, sampled_num in zip(self.sample_classes,
                                           sample_num_per_class):
            if first:
                if sampled_num > 0:
                    sampled_cls = self.sample_class_first(class_name, sampled_num)
    ...
    def sample_class_first(self, name, num):
