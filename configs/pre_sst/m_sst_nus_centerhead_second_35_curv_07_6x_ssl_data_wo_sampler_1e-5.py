...
model = dict(
    ...
    backbone=dict(
        ...
        eval_flag=False,
        model_path='./work_dirs/m_sst_nus_singlestage_curv_07_20e/epoch_20.pth',
        d_model=[128, ] * 6,
        nhead=[8, ] * 6,
        num_blocks=6,
...
load_from = 'work_dirs/m_sst_nus_singlestage_curv_07_ssl_dataset_wo_dbsampler_6x_1e-5/epoch_72.pth'
